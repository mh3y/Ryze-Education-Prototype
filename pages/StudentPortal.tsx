      ...
      <div className="relative z-20 w-full max-w-md px-6">
        <div className="bg-[#0a0f1e] border border-white/10 p-8 rounded-3xl shadow-2xl backdrop-blur-xl">
            <div className="text-center mb-8">
               ...
               <p className="text-sm text-slate-500">Sign in to view your tasks and progress.</p>
            </div>

            <form onSubmit={handleLogin} className="space-y-5">
              <div>
                <label className="block text-[10px] font-bold text-slate-500 uppercase tracking-widest mb-2">Student Email</label>
              ...
              <div className="flex items-center justify-between text-xs">
                ...
                <a href="#" className="text-[#FFB000] hover:text-white transition-colors">Forgot Password?</a>
              </div>
            ...
            <div className="mt-8 pt-6 border-t border-white/5 text-center">
               <p className="text-xs text-slate-600">
                  Need an account? <Link to="/contact" className="text-[#FFB000] hover:underline">Contact Admin</Link>
               </p>
            </div>
        </div>
      </div>
