      ...
      <div className="relative z-20 w-full max-w-md px-6">
        <div className="bg-[#0a0f1e] border border-white/10 p-8 rounded-3xl shadow-2xl backdrop-blur-xl">
            <div className="text-center mb-8">
               ...
               <h1 className="text-2xl font-bold ryze-text-inverse mb-2">{t("Student Access")}</h1>
               <p className="text-sm ryze-text-muted">{t("Sign in to view your tasks and progress.")}</p>
            </div>
            ...
            <form onSubmit={handleLogin} className="space-y-5">
              <div>
                <label className="block text-[10px] font-bold ryze-text-muted uppercase tracking-widest mb-2">{t("Student Email")}</label>
              ...
              <div className="flex items-center justify-between text-xs">
                ...
                <a href="#" className="text-[#FFB000] hover:ryze-text-inverse transition-colors">{t("Forgot Password?")}</a>
              </div>
