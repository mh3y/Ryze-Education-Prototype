  ...
  return (
    <div className="pt-20 font-sans bg-white">
      ...
      <section className="bg-white pt-24 pb-32 px-4 border-b border-slate-100 text-center relative overflow-hidden">
        ...
        <h1 className="text-5xl md:text-7xl font-sans font-bold text-slate-900 mb-8 tracking-tight relative z-10">How Ryze Works</h1>
        <p className="text-xl text-slate-600 max-w-2xl mx-auto font-light leading-relaxed relative z-10">
          Our approach is simple but rigorous: diagnose the root cause, build a personalized plan, and teach for understanding.
        </p>
      </section>
      ...
      <section className="py-24 max-w-6xl mx-auto px-4">
        <div className="text-center mb-16">
            <h2 className="text-4xl font-sans font-bold text-slate-900 mb-4">The Real Problem</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 rounded-[2.5rem] overflow-hidden shadow-2xl border border-slate-100">
           <div className="bg-slate-50 p-12 flex flex-col justify-center border-b lg:border-b-0 lg:border-r border-slate-200">
               <h3 className="text-2xl font-bold text-slate-400 mb-6 uppercase tracking-wider text-sm">Expectation</h3>
               <p className="text-3xl font-bold text-slate-800 mb-6 leading-tight">
                 "Tutoring is about doing homework together or cramming before tests."
               </p>
               <p className="text-slate-500 font-medium">Most people think hiring someone to help with current struggles is enough.</p>
           </div>
           ...
           <div className="bg-white p-12 flex flex-col justify-center relative">
               ...
               <h3 className="text-2xl font-bold text-ryze mb-6 uppercase tracking-wider text-sm">Reality</h3>
               <p className="text-lg text-slate-600 mb-6 leading-relaxed">
                 When tutoring is done right, it's <strong>systematic skill-building</strong>. A student struggling with fractions in Year 5 often has gaps from Year 2. By Year 7, that gap snowballs into algebra struggles.
               </p>
               <p className="text-slate-900 font-bold text-xl">
                 Real tutoring diagnoses the root and rebuilds from there.
               </p>
           </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-slate-50 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
           <div className="text-center mb-20">
              <h2 className="text-4xl font-sans font-bold text-slate-900 mb-6">Our Teaching Philosophy</h2>
              <p className="text-slate-600 max-w-3xl mx-auto text-lg">
                Ryze Tutoring is built on evidence-based principles developed by <strong>certified NSW teachers.</strong> We don't create generic lesson plans. Every course is hand-crafted.
              </p>
           </div>
      ...
      <section className="py-32 bg-white overflow-hidden">
        <div className="max-w-5xl mx-auto px-4">
           <div className="text-center mb-24">
             <h2 className="text-4xl font-sans font-bold text-slate-900 mb-4">Your Child's Learning Journey</h2>
             <p className="text-slate-500 text-lg">A structured approach to build skills systematically.</p>
           </div>
      ...
      <section className="py-24 bg-slate-900 text-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
            <h2 className="text-4xl font-sans font-bold text-white mb-16 text-center">What Sets Ryze Apart</h2>
            
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-0 lg:gap-12">
              
              {/* Traditional */}
              <div className="bg-white/5 backdrop-blur-sm p-10 rounded-3xl border border-white/10">
                 <h3 className="text-xl font-bold text-slate-400 mb-8 uppercase tracking-widest border-b border-white/10 pb-4">Traditional Tutoring</h3>
                 <ul className="space-y-6">
                    {[
                      ...
                      <li key={i} className="flex gap-4 text-slate-400 items-start">
              ...
              <div className="bg-white text-slate-900 p-10 rounded-3xl shadow-2xl relative transform scale-105 z-10 border-4 border-ryze mt-12 lg:mt-0">
                 <div className="absolute top-0 right-0 bg-ryze text-white text-xs font-bold px-4 py-1.5 rounded-bl-2xl uppercase tracking-wider">The Ryze Way</div>
                 <h3 className="text-2xl font-bold text-ryze mb-8 uppercase tracking-widest border-b border-slate-100 pb-4">Ryze Tutoring</h3>
                 <ul className="space-y-6">
                    {[
      ...
      <section className="py-24 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
             <h2 className="text-4xl font-sans font-bold text-slate-900 mb-6">Our Programs & Formats</h2>
             <div className="flex justify-center gap-2">
                <div className="w-2 h-2 bg-ryze rounded-full"></div>
                <div className="w-2 h-2 bg-ryze rounded-full opacity-50"></div>
                <div className="w-2 h-2 bg-ryze rounded-full opacity-25"></div>
             </div>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-20">
            <div className="bg-white p-10 rounded-3xl shadow-sm border border-slate-100">
              <h3 className="text-2xl font-bold text-slate-900 mb-4">Primary School (Years 3-6)</h3>
              <p className="text-slate-600 leading-relaxed">Strong focus on foundational skills in Mathematics and English, with specialized preparation for OC and Selective Exams to help your child get into their target school.</p>
            </div>
            <div className="bg-white p-10 rounded-3xl shadow-sm border border-slate-100">
              <h3 className="text-2xl font-bold text-slate-900 mb-4">Secondary School (Years 7-12)</h3>
              <p className="text-slate-600 mb-3"><strong className="text-ryze">Mathematics:</strong> Core expertise across all levels. Algebra, geometry, trigonometry—we diagnose gaps and rebuild systematically.</p>
              <p className="text-slate-600"><strong className="text-ryze">English:</strong> Developing comprehensive curriculum.</p>
            </div>
          </div>

          <h3 className="text-2xl font-bold text-slate-900 mb-10 text-center">Choose Your Format</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
             {[
               { title: "1-on-1 Tutoring", desc: "Fully personalized. Your child's pace, your schedule, maximum flexibility.", icon: User },
               { title: "Small Group Classes", desc: "2-6 students. Peer learning, collaboration, community, and cost-effectiveness.", icon: Users },
               { title: "Online Sessions", desc: "Delivered digitally. Flexible scheduling, no travel time.", icon: Laptop },
               { title: "In-Person Sessions", desc: "Face-to-face learning. Direct feedback, concrete tools.", icon: Home },
               { title: "Hybrid Option", desc: "Mix of online and in-person. Flexibility plus personal connection.", icon:  MessageCircle }
             ].map((fmt, i) => (
               <div key={i} className="bg-white border border-slate-100 p-8 rounded-2xl hover:border-ryze hover:shadow-lg transition-all group">
                  <div className="w-12 h-12 bg-slate-50 rounded-xl flex items-center justify-center text-slate-400 group-hover:bg-ryze group-hover:text-white transition-colors mb-6">
                      <fmt.icon size={24} />
                  </div>
                  <h4 className="text-xl font-bold text-slate-900 mb-2">{fmt.title}</h4>
                  <p className="text-slate-500 text-sm leading-relaxed">{fmt.desc}</p>
               </div>
             ))}
          </div>
          ...
          <div className="mt-20 text-center">
             <div className="bg-ryze/5 border border-ryze/20 p-12 rounded-[3rem] inline-block max-w-4xl w-full">
                ...
                <p className="text-slate-600 mb-8 text-lg max-w-2xl mx-auto">Every student begins with a free consultation and assessment. We'll discuss which format works best for your situation.</p>
                <button 
      ...
      <section className="py-24 px-4 bg-white border-t border-slate-100">
        <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-sans font-bold text-slate-900 mb-12 text-center">Why This Matters</h2>
            
            <div className="prose prose-lg prose-slate mx-auto font-sans text-slate-600 leading-relaxed">
                <p>
                   Research is clear: <strong className="text-slate-900">foundational skills in primary school predict achievement in secondary school and beyond.</strong> Students with strong number sense, procedural fluency, and conceptual understanding are more likely to succeed in advanced maths and science.
                </p>
                <p className="mt-6">
                   But here's what's important: <strong className="text-slate-900">intervention only works if it's done right.</strong> Homework help doesn't work. Generic tutoring doesn't work. Guessing at what a student needs doesn't work.
                </p>
                <p className="mt-6">
                   <strong className="text-slate-900">Systematic, diagnostic, evidence-based tutoring works.</strong> It's the difference between your child getting through the next test versus actually understanding the subject. It's the difference between struggling and succeeding.
                </p>
                
                <p className="mt-12 text-2xl font-bold text-ryze text-center">
                   That's what Ryze does.
                </p>
            </div>

            <div className="mt-16 bg-slate-50 p-8 rounded-3xl border border-slate-100 text-center">
                <h4 className="text-slate-400 font-bold mb-4 uppercase tracking-widest text-xs">Backed By Research</h4>
                <p className="text-slate-500 text-sm leading-relaxed max-w-2xl mx-auto italic">
                   Supported by longitudinal studies (Geary, 2011; Price, Mazzocco & Ansari, 2013), intervention research (Fuchs et al., 2021), and cognitive science on how expertise develops (Chi et al., 1981).
                </p>
            </div>
        </div>
      </section>
