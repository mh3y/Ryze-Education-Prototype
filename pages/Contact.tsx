        ...
        <div className="bg-[#f8fafc] px-4 sm:px-6 lg:px-8 py-20">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 max-w-5xl mx-auto -mt-32">
            ...
            <div className="bg-white rounded-[2.5rem] shadow-xl p-12 flex flex-col items-center text-center border border-slate-100 h-full hover:-translate-y-2 transition-transform duration-300 group">
                ...
                <h2 className="text-3xl font-bold text-slate-900 mb-4">{t("Prefer to Speak now?")}</h2>
            ...
            <div className="bg-white rounded-[2.5rem] shadow-xl p-12 flex flex-col items-center text-center border border-slate-100 h-full hover:-translate-y-2 transition-transform duration-300 group">
                ...
                <h2 className="text-3xl font-bold text-slate-900 mb-4">{t("Message Us")}</h2>
      ...
      <section id="contact-form-section" className="py-24 bg-white border-t border-slate-100">
         <div className="max-w-2xl mx-auto px-4">
            <div className="text-center mb-12">
                <h3 className="text-3xl font-bold text-slate-900 mb-4">{t("Send us a Message")}</h3>
                <p className="text-slate-500">{t("We typically respond within 24 hours.")}</p>
            </div>
            ...
            {status === 'success' ? (
              <div className="bg-green-50 border border-green-200 rounded-[2rem] p-10 text-center animate-in fade-in zoom-in duration-300">
                 ...
                 <h4 className="text-2xl font-bold text-slate-900 mb-4">{t("Message Sent!")}</h4>
              ...
              <form onSubmit={handleSubmit} className="space-y-6 relative">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      <label htmlFor="name" className="block text-sm font-bold text-slate-700 uppercase tracking-wider">{t("Name")}</label>
                      <input
                        type="text"
                        id="name"
                        name="name"
                    ...
                    <div className="space-y-2">
                      <label htmlFor="email" className="block text-sm font-bold text-slate-700 uppercase tracking-wider">{t("Email")}</label>
                      <input
                        type="email"
                        id="email"
                        name="email"
                  ...
                  <div className="space-y-2">
                    <label htmlFor="phone" className="block text-sm font-bold text-slate-700 uppercase tracking-wider">{t("Phone")}</label>
                    <input
                      type="tel"
                      id="phone"
                      name="phone"
