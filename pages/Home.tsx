...
const Home: React.FC = () => {
  ...
  return (
    <div className="ryze-page-shell--hero-bleed w-full overflow-hidden bg-[var(--ryze-surface-dark)] font-sans md:ryze-bg-primary">
      <section className="ryze-hero-edge ryze-shell-grid relative min-h-screen min-h-[100dvh] overflow-hidden ryze-bg-surface-dark pb-12 pt-[5.2rem] md:pb-14 md:pt-[6.25rem] lg:pb-16 lg:pt-[6.5rem]">
        <picture className="ryze-hero-visual-bleed">
          <img
