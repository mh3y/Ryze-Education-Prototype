  ...
  const sections = [
    {
      ...
      links: [
        ...
        { name: 'HSC Maths', path: ROUTES.HSC_MATHS_PROGRAM },
        { name: 'Accelerated Maths', path: ROUTES.ACCELERATED_MATHS_PROGRAM },
        { name: 'Junior Foundations', path: ROUTES.JUNIOR_FOUNDATIONS_PROGRAM },
        { name: 'OC & Selective Exam Preparation', path: ROUTES.SELECTIVE_OC_PROGRAM },
        { name: 'Primary Maths', path: ROUTES.PRIMARY_MATHS_PROGRAM },
