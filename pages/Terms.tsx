      ...
      <div className="mx-auto max-w-4xl px-4 py-20 sm:px-6 lg:px-8">
        <div className="ryze-page-card p-8 md:p-12">
          <section className="mb-12">
            <h3 className="mb-4 text-2xl font-bold ryze-text-primary">1. About These Terms</h3>
          ...
          <section className="mb-12">
            <h3 className="mb-4 text-2xl font-bold ryze-text-primary">4. How Our Services Work</h3>
            <p className="mb-4 leading-relaxed ryze-text-secondary">
              <strong className="ryze-text-primary">Personalised Learning:</strong> We collect observational data during tutoring sessions - including the Student&apos;s performance, progress, learning patterns, and engagement - to personalise the Student&apos;s learning experience. This data is primarily used to benefit each individual Student and optimise their own educational journey with us.
            </p>
            <p className="mb-4 leading-relaxed ryze-text-secondary">
              <strong className="ryze-text-primary">Curriculum Design:</strong> Tutors, curriculum designers, and our team may access your Student&apos;s data to continuously improve our teaching methods, content, and systems. This access is strictly for improving the Student&apos;s experience and the quality of our tutoring.
            </p>
            <p className="mb-4 leading-relaxed ryze-text-secondary">
              <strong className="ryze-text-primary">Future Collective Use:</strong> While your Student&apos;s data is collected primarily for their individual benefit, we may in the future anonymise and aggregate this data (with your consent) to strengthen our AI systems and improve tutoring for future students. Any such use will be clearly optional, and you retain the right to request exclusion at any time.
            </p>
          </section>

          <section className="mb-12">
            <h3 className="mb-4 text-2xl font-bold ryze-text-primary">5. Payment Terms</h3>
            <p className="mb-4 leading-relaxed ryze-text-secondary">
              <strong className="ryze-text-primary">Fees:</strong> Payment terms, pricing, and any applicable packages will be confirmed in writing before services commence.
            </p>
            <p className="mb-4 leading-relaxed ryze-text-secondary">
              <strong className="ryze-text-primary">Refund Policy:</strong> Fees are non-refundable except where required by Australian Consumer Law or as otherwise agreed in writing.
            </p>
            <p className="mb-4 leading-relaxed ryze-text-secondary">
              <strong className="ryze-text-primary">Payment Methods:</strong> We accept Credit Card and Direct Debit via our secure invoicing platform. Payment must be made by the due date specified in your invoice.
            </p>
            <p className="mb-4 leading-relaxed ryze-text-secondary">
              <strong className="ryze-text-primary">Non-Payment:</strong> If payment is not received by the due date, we reserve the right to suspend services until payment is made in full.
            </p>
          </section>

          <section className="mb-12">
            <h3 className="mb-4 text-2xl font-bold ryze-text-primary">6. Cancellation and Termination</h3>
            <p className="mb-4 leading-relaxed ryze-text-secondary">
              <strong className="ryze-text-primary">Cancellation by you:</strong> You may cancel services by providing written notice to <a href="mailto:ryzeeducation@outlook.com" className="font-bold text-[var(--accent)] hover:underline">ryzeeducation@outlook.com</a>. Your cancellation notice should specify whether you wish to retain or request deletion of the Student&apos;s data.
            </p>
            <p className="mb-4 leading-relaxed ryze-text-secondary">
              <strong className="ryze-text-primary">Termination by us:</strong> We reserve the right to terminate services if:
            </p>
            <ul className="mb-4 list-disc space-y-2 pl-6 ryze-text-secondary">
            ...
            <p className="mb-4 leading-relaxed ryze-text-secondary">We will provide 2 weeks&apos; written notice where reasonably practicable.</p>
          </section>

          <section className="mb-12">
            <h3 className="mb-4 text-2xl font-bold ryze-text-primary">7. Student and Parent Conduct</h3>
            <p className="mb-4 leading-relaxed ryze-text-secondary">You and the Student agree not to:</p>
            <ul className="mb-4 list-disc space-y-2 pl-6 ryze-text-secondary">
            ...
            <p className="mb-4 leading-relaxed ryze-text-secondary">Breach of this section may result in immediate termination.</p>
          </section>

          <section className="mb-12">
            <h3 className="mb-4 text-2xl font-bold ryze-text-primary">8. Intellectual Property</h3>
            <p className="mb-4 leading-relaxed ryze-text-secondary">
          ...
          <section className="mb-12">
            <h3 className="mb-4 text-2xl font-bold ryze-text-primary">9. Limitation of Liability</h3>
            <p className="mb-4 leading-relaxed ryze-text-secondary">
              <strong className="ryze-text-primary">To the maximum extent permitted by Australian law:</strong>
            </p>
            <p className="mb-4 leading-relaxed ryze-text-secondary">
            ...
            <p className="mb-4 leading-relaxed ryze-text-secondary">
              <strong className="ryze-text-primary">Except where prohibited by Australian Consumer Law, our liability is limited to the amount paid for services in the 12 months preceding the claim.</strong> We are not liable for indirect, incidental, consequential, or punitive damages arising from use of our services, even if advised of the possibility of such damages.
            </p>
            <p className="mb-4 leading-relaxed ryze-text-secondary">
              <strong className="ryze-text-primary">Australian Consumer Law:</strong> Nothing in these terms excludes, restricts, or modifies any condition, warranty, or guarantee, or any right you have under the Australian Consumer Law where such exclusion is prohibited.
            </p>
          </section>

          <section className="mb-12">
            <h3 className="mb-4 text-2xl font-bold ryze-text-primary">10. Indemnity</h3>
            <p className="mb-4 leading-relaxed ryze-text-secondary">
          ...
          <section className="mb-12">
            <h3 className="mb-4 text-2xl font-bold ryze-text-primary">11. Disputes and Governing Law</h3>
            <p className="mb-4 leading-relaxed ryze-text-secondary">
              <strong className="ryze-text-primary">Governing Law:</strong> These terms are governed by the laws of Australia, specifically the jurisdiction in which Ryze Education operates (NSW).
            </p>
            <p className="mb-4 leading-relaxed ryze-text-secondary">
              <strong className="ryze-text-primary">Dispute Resolution:</strong> Before initiating formal proceedings, we encourage you to contact us to resolve disputes informally. If informal resolution fails, disputes will be subject to the laws and court system of Australia.
            </p>
          </section>

          <section className="mb-12">
            <h3 className="mb-4 text-2xl font-bold ryze-text-primary">12. Changes to These Terms</h3>
            <p className="mb-4 leading-relaxed ryze-text-secondary">
          ...
          <section className="mb-12">
            <h3 className="mb-4 text-2xl font-bold ryze-text-primary">13. Entire Agreement</h3>
            <p className="mb-4 leading-relaxed ryze-text-secondary">
          ...
          <hr className="my-12 ryze-border-subtle" />

          <div className="rounded-[1.6rem] border border-[rgba(184,132,30,0.16)] bg-[rgba(243,231,201,0.52)] p-8">
            <h4 className="mb-2 font-bold ryze-text-primary">Acknowledgment</h4>
            <p className="text-sm leading-relaxed ryze-text-secondary">
