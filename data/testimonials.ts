...
export const testimonials: Testimonial[] = [
  // --- OC PLACEMENT (Min 5) ---
  {
    ...
    achievement: "Transformed exam-day anxiety into focus",
    accent: "blue",
    category: "OC",
  ...
  },
  {
    ...
    achievement: "Mastered complex word problems",
    accent: "blue",
    category: "OC",
  ...
  },
  {
    ...
    achievement: "Aced the high-difficulty sections",
    accent: "blue",
    category: "OC",
  ...
  },
  {
    ...
    achievement: "Perfected exam pacing and time management",
    accent: "blue",
    category: "OC",
  ...
  },
  {
    ...
    achievement: "Perfected logical thinking skills",
    accent: "blue",
    category: "OC",
  ...
  // --- SELECTIVE ENTRY (Min 5) ---
  {
    ...
    achievement: "Reached her first-choice school",
    accent: "green",
    category: "Selective",
  ...
  },
  {
    ...
    achievement: "Top-tier selective achievement",
    accent: "green",
    category: "Selective",
  ...
  },
  {
    ...
    achievement: "Built incredible exam resilience",
    accent: "green",
    category: "Selective",
  ...
  },
  {
    ...
    achievement: "Sharpened mathematical precision",
    accent: "green",
    category: "Selective",
  ...
  },
  {
    ...
    achievement: "Consistently met growth targets",
    accent: "green",
    category: "Selective",
  ...
  // --- NAPLAN (Min 5) ---
  {
    ...
    achievement: "Top 5% state-wide result",
    accent: "purple",
    category: "NAPLAN",
  ...
  },
  {
    ...
    achievement: "Complete shift in math confidence",
    accent: "purple",
    category: "NAPLAN",
  ...
  },
  {
    ...
    achievement: "Achieved 100% test accuracy",
    accent: "purple",
    category: "NAPLAN",
  ...
  },
  {
    ...
    achievement: "Caught up on foundational gaps",
    accent: "purple",
    category: "NAPLAN",
  ...
  },
  {
    ...
    achievement: "Secured highest proficiency band",
    accent: "purple",
    category: "NAPLAN",
  ...
  // --- HSC (Year 12 Only, Min 5) ---
  {
    ...
    achievement: "On track for Band 6 result",
    accent: "orange",
    category: "HSC",
  ...
  },
  {
    ...
    achievement: "Amazing ATAR & 4U Performance",
    accent: "orange",
    category: "HSC",
  ...
  },
  {
    ...
    achievement: "Mathematics as top HSC subject",
    accent: "orange",
    category: "HSC",
  ...
  },
  {
    ...
    achievement: "Exceptional E4 performance",
    accent: "orange",
    category: "HSC",
  ...
  },
  {
    ...
    achievement: "Massive rank turnaround",
    accent: "orange",
    category: "HSC",
  ...
  },
  {
    ...
    achievement: "Exceptional Band 6 Performance",
    accent: "orange",
    category: "HSC",
  ...
  // --- COMPETITIONS (Min 5) ---
  {
    ...
    achievement: "Top 1% National Ranking",
    accent: "yellow",
  ...
  },
  {
    ...
    achievement: "Highest state-wide achievement",
    accent: "yellow",
    category: "Competitions",
  ...
  },
  {
    ...
    achievement: "Excellence in advanced problem solving",
    accent: "yellow",
    category: "Competitions",
  ...
  // --- PRIMARY (K-6 General) (Min 5) ---
  {
    ...
    achievement: "Strong academic foundation built",
    accent: "pink",
  ...
  },
  {
    ...
    achievement: "Selected for accelerated learning",
    accent: "pink",
    category: "Primary (K-6)",
  ...
  },
  {
    ...
    achievement: "Dramatic boost in mental math speed",
    accent: "pink",
    category: "Primary (K-6)",
  ...
  },
  {
    ...
    achievement: "From C-grade to A-grade excellence",
    accent: "pink",
    category: "Primary (K-6)",
  ...
  },
  {
    ...
    achievement: "Restored love for learning math",
    accent: "pink",
    category: "Primary (K-6)",
  ...
  // --- HIGH SCHOOL (7-12 General) (Min 5) ---
  {
    ...
    achievement: "Ranked 2nd in school cohort",
    accent: "indigo",
  ...
  },
  {
    ...
    achievement: "Consistent high-distinction performance",
    accent: "indigo",
    category: "High School (7-12)",
  ...
  },
  {
    ...
    achievement: "Improved school rank from 8th to 3rd",
    accent: "indigo",
    category: "High School (7-12)",
  ...
  },
  {
    ...
    achievement: "Achieved 1st rank in mathematics",
    accent: "indigo",
    category: "High School (7-12)",
  ...
  },
  {
    ...
    achievement: "Strong transition to high school math",
    accent: "indigo",
    category: "High School (7-12)",
